...
urlpatterns = [
    ...
    path('All-personal-trans/<pk>/', alltranpersonal , name="alltranpersonal"),
    path('personal-delete-persoansj/<pk>/<cc>/', allptrandeleteallpersonal , name="allptrandeleteallpersonal"),
    path('personal-tran-approved-rer/<pk>/<cc>/', alldisptranapprovedpersona , name="alldisptranapprovedpersona"),
    path('personal-tran-approved-ressr/<pk>/<cc>/', allptranapprovedperson , name="allptranapprovedperson"),



    path('Activated/', Activated , name="Activated"),
    path('disabled/', disabledaccount , name="disabledaccount"),
    path('Corporate/', Coprate , name="Coprate"),
    path('whtanext/', whtanext , name="whtanext"),
    path('whtanext_e/', whtanext2 , name="whtanext2"),
    path('whtanext_q', whtanext1 , name="whtanext1"),
    path('legalresouce/', legalresouce , name="legalresouce"),
    path('imprint/', imprint , name="imprint"),
    path('report/', report , name="report"),
    path('hisCope/', histrocal , name="histrocal"),
    path('g-net/', glorbalnte , name="glorbalnte"),
    path('c-future/', carrer , name="carrer"),
    path('access_bil/', accessbil , name="accessbil"),
    path('data-p/', datap , name="datap"),
    path('respo/', respo , name="respo"),
    path('media/', media , name="media"),
    path('news/', news , name="news"),
    path('contact/', contact , name="contact"),
    path('c-pretive/', contcopreativact , name="contcopreativact"),
